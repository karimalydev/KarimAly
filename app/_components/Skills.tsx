        ...
        <section id="my-stack" ref={containerRef}>
            <div className="container">
                ...
                <div className="space-y-20">
                    {Object.entries(MY_STACK).map(([key, value], index) => {
                        const accentColors = [
                            'text-bright-blue dark:text-bright-blue',
                        ...
                        return (
                            <div className="grid sm:grid-cols-12" key={key}>
                                <div className="sm:col-span-5">
                                    <p className={`slide-up text-5xl font-anton leading-none uppercase ${accentColors[index % accentColors.length]} transition-colors`}>
                                        {key}
                                    </p>
                                </div>
